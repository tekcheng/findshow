...
import com.megamusic.findshow.domain.trans.AliyunVideoTransDto;
...
//    }
    ...
    public AliyunVideoTransDto getAliyunVideo(String videoId) {
        //生成私有参数，不同API需要修改
        ...
        //发送HTTP GET 请求
        AliyunVideoTransDto aliyunVideoTransDto;
        try {
            String httpResult = httpGet(URL);
            aliyunVideoTransDto = JSON.parseObject(httpResult, AliyunVideoTransDto.class);
            return aliyunVideoTransDto;
        } catch (Exception e) {
